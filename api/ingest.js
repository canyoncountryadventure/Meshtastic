...
const EXPERIMENT_STORE_INTERVAL_MINUTES = 5;
...
function fiveMinuteBucket(observedAt){const startMs=Math.floor(observedAt.getTime()/EXPERIMENT_STORE_INTERVAL_MS)*EXPERIMENT_STORE_INTERVAL_MS;return{start:new Date(startMs),end:new Date(startMs+EXPERIMENT_STORE_INTERVAL_MS)}}
